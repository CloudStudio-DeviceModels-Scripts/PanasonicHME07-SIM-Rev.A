...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("2", "Presión", endpointType.pressureSensor);
  var e = endpoints.addEndpoint("3", "Caudal", endpointType.genericSensor);
  e.variableTypeId = 1365;
  var e = endpoints.addEndpoint("4", "Velocidad Variador", endpointType.genericSensor);
  e.variableTypeId = 1366;
  var e = endpoints.addEndpoint("5", "Válvula", endpointType.genericSensor);
  e.variableTypeId = 1367;
  var e = endpoints.addEndpoint("6", "Bomba", endpointType.genericSensor);
